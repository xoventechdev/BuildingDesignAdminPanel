...
$buildings = $pdo->query("SELECT * FROM buildingitem ORDER BY id DESC")->fetchAll(PDO::FETCH_ASSOC);
      ...
      <div class="main-panel">
        ...
        <div class="content-wrapper">
          <div class="page-header">
            <h3 class="page-title"> View Design </h3>
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="./design-add.php">Add Design</a></li>
                <li class="breadcrumb-item active" aria-current="page">View Design</li>
              </ol>
            </nav>
          </div>
          <div class="card">
                        ...
                        <div class="col-sm-12">
                          <table id="order-listing" class="table dataTable no-footer"
                            ...
                            <thead>
                              <tr>
                                ...
                                <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1"
                                  ...
                                  style="width: 97.1562px;">Title</th>
                                <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1"
                                ...
                                <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1"
                                  aria-label="Status: activate to sort column ascending" style="width: 65.2292px;">
                                  Design</th>
                                <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1"
                            ...
                            <?php foreach ($buildings as $index => $building): ?>
                              <tr>
                                <td class="sorting_1"><?php echo $building['id']; ?></td>
                                <td><?php echo $building['title']; ?></td>
                                <td><?php echo $building['bedRoom']; ?></td>
                                <td><?php echo $building['viewCount']; ?></td>
                                <td><?php echo $building['status']; ?></td>
                                <td>
                                <img src="<?php echo htmlspecialchars($building['fontDesign']); ?>" alt="Font Design">
                                </td>
                                </td>
                                <td>
                                  <a class="btn btn-outline-primary" href="design-edit.php?id=<?php echo $building['id']; ?>">Edit</a>
                                  <button class="btn btn-outline-danger" onclick="showSwal('<?php echo $building['id']; ?>')">Delete</button>
  ...
  swal({
    ...
    if (isConfirmed) {
      ...
      fetch('./api/design.php', {
        ...
        body: JSON.stringify({ id: id, key : 'itemDelete' }),
      })
        .then((response) => {
